...
**You may not need it.** If your only goal is to stay under the grid tariff step, the hard cap alone already does that. The daily budget is the extra layer you add for cheap-hour shifting or conscious whole-home reduction, and it is off by default.
