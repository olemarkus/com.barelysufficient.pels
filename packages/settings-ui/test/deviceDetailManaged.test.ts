...
describe('device detail managed state saves', () => {
  ...
  it('keeps the currently open device panel stable when an earlier managed save resolves late', async () => {
    ...
    const managedInput = document.querySelector('#device-detail-managed') as (HTMLElement & { selected: boolean }) | null;
  ...
  it('requires transient confirmation before enabling built-in device control', async () => {
    ...
    const nativeWiringInput = document.querySelector('#device-detail-native-wiring') as (HTMLElement & { selected: boolean }) | null;
    const confirmRow = document.querySelector('#device-detail-native-wiring-confirm-row') as HTMLElement | null;
    const confirmInput = document.querySelector('#device-detail-native-wiring-confirm') as (HTMLElement & { selected: boolean }) | null;
    const managedInput = document.querySelector('#device-detail-managed') as (HTMLElement & { selected: boolean }) | null;
  ...
  it('restores the controllable checkbox when saving fails', async () => {
    ...
    const controllableInput = document.querySelector('#device-detail-controllable') as (HTMLElement & { selected: boolean }) | null;
  ...
  it('keeps the delta section state tied to the currently open device when an earlier price-opt save resolves late', async () => {
    ...
    const cheapDeltaInput = document.querySelector('#device-detail-cheap-delta') as (HTMLElement & { selected: boolean }) | null;
  ...
  it('restores the control model when saving the profile fails', async () => {
    ...
    const controlModelInput = document.querySelector('#device-detail-control-model') as (HTMLElement & { value: string }) | null;
  ...
  it('shows and saves temperature boost settings for stepped temperature devices', async () => {
    ...
    const boostBelow = document.querySelector('#device-detail-temperature-boost-below') as (HTMLElement & { selected: boolean }) | null;
  ...
  it('shows and saves EV boost settings for stepped EV chargers', async () => {
    ...
    const boostBelow = document.querySelector('#device-detail-ev-boost-below') as (HTMLElement & { selected: boolean }) | null;
