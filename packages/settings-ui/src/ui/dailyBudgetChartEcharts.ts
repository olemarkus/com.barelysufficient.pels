...
const resolvePalette = (barsEl: HTMLElement): DailyBudgetPalette => ({
  planned: resolveCssColor(barsEl, '--day-view-color-planned', '#10b981'),
  uncontrolled: resolveCssColor(barsEl, '--day-view-color-background-usage', '#64b5f6'),
  controlled: resolveCssColor(barsEl, '--day-view-color-managed-usage', '#ffc107'),
  actual: resolveCssColor(barsEl, '--day-view-color-actual', '#e6ecf5'),
  actualUncontrolled: resolveCssColor(barsEl, '--day-view-color-actual-background-usage', 'rgba(100, 181, 246, 0.45)'),
  actualControlled: resolveCssColor(barsEl, '--day-view-color-actual-managed-usage', 'rgba(255, 193, 7, 0.45)'),
  over: resolveCssColor(barsEl, '--color-state-warning-border', 'rgba(255, 193, 7, 0.4)'),
  disabled: resolveCssColor(barsEl, '--color-surface-4', 'rgba(255, 255, 255, 0.08)'),
  disabledMarker: resolveCssColor(barsEl, '--color-surface-5', 'rgba(255, 255, 255, 0.12)'),
  muted: resolveCssColor(barsEl, '--muted', '#a8b8c8'),
  grid: resolveCssColor(barsEl, '--color-border-strong', 'rgba(255, 255, 255, 0.20)'),
  panel: resolveCssColor(barsEl, '--color-surface-1', 'rgba(255, 255, 255, 0.04)'),
  text: resolveCssColor(barsEl, '--text', '#e6ecf5'),
  currentBorder: resolveCssColor(barsEl, '--color-state-warning-border', 'rgba(255, 193, 7, 0.4)'),
  tooltipBackground: resolveCssColor(barsEl, '--color-overlay-toast', 'rgba(12, 17, 27, 0.9)'),
