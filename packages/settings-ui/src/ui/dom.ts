...
export const usageQualityList = qs('#usage-quality-list');
...
export const dailyBudgetHeadline = qs('#daily-budget-headline');
export const dailyBudgetSummaryText = qs('#daily-budget-summary-text');
export const dailyBudgetLimiterChip = qs('#daily-budget-limiter-chip');
export const dailyBudgetShapingChip = qs('#daily-budget-shaping-chip');
export const dailyBudgetExemptChip = qs('#daily-budget-exempt-chip');
export const dailyBudgetUsed = qs('#daily-budget-used');
export const dailyBudgetAllowed = qs('#daily-budget-allowed');
...
export const dailyBudgetExplainList = qs('#daily-budget-explain-list');
...
export const dailyBudgetControlledWeightValue = qs('#daily-budget-controlled-weight-value');
export const dailyBudgetPriceFlexShareValue = qs('#daily-budget-price-flex-share-value');
export const dailyBudgetControlledPreview = qs('#daily-budget-controlled-preview');
export const dailyBudgetPriceFlexPreview = qs('#daily-budget-price-flex-preview');
export const dailyBudgetTuningResetButton = document.querySelector('#daily-budget-tuning-reset') as HTMLButtonElement;
export const dailyBudgetTuningSummary = qs('#daily-budget-tuning-summary');
