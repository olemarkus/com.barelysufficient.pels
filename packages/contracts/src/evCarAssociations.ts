import type { EvCarAssociations } from './types.js';

/**
 * Browser-side copy of `lib/utils/evCarAssociations.ts`. Kept duplicated on
 * purpose: runtime code may not take a value dependency on this package
 * (`no-runtime-value-deps-on-contracts`), and the settings UI may not import
 * `lib/**`. Change both together — `test/unit/evCarAssociations.test.ts`
 * asserts they agree.
 */
