...
export const normalizePlanMeta = (meta: DevicePlan['meta']): DevicePlan['meta'] => ({
  ...
  shortfallThresholdKw: roundOptional(meta.shortfallThresholdKw, PLAN_META_KW_STEP),
...
export const normalizePelsStatus = (
  ...
  return {
    ...
    shortfallThresholdKw: roundOptional(status.shortfallThresholdKw, PLAN_META_KW_STEP),
