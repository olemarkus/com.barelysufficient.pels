...
| `lib/plan/shedding/buildSheddingPlan.ts` | 676 | Candidate split by shed-action kind; then move step/temperature target projection toward the executor boundary. |
