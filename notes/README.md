...
- `complexity-cleanup/README.md`: phased plan for reducing runtime complexity — backoff
  simplification, reason/decision separation, executor/app/service/deviceManager splits.
...
- `plan-module-simplification/README.md`: plan module indirection analysis, merge candidates,
  and simplification candidates for the `lib/plan/` directory.
- `restore-eagerness/README.md`: restore eagerness investigation, hypotheses, test coverage,
  logging gaps, and fix progress.
