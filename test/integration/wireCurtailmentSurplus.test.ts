...
// term on the 15-min hold ladder (suppressed well past the 90 s import latch),
// whereas an import with NO open window is a bare latch (the term returns after 90 s).
