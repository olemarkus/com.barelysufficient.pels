...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      comment: 'Home is a pure leaf domain (multi-home config + membership resolution; dormant '
        + 'until the R4 wiring PR): zone tree, sub-home configs, and pins arrive as plain typed '
