...
export const dailyBudgetAggressivenessSelect = document.querySelector('#daily-budget-aggressiveness') as HTMLSelectElement;
...
export const dailyBudgetPressure = qs('#daily-budget-pressure');
...
export const dailyBudgetLine = document.querySelector('#daily-budget-line') as SVGSVGElement;
export const dailyBudgetLinePath = document.querySelector('#daily-budget-line-path') as SVGPolylineElement;
...
export const dailyBudgetFrozen = qs('#daily-budget-frozen');
export const dailyBudgetRefreshButton = document.querySelector('#daily-budget-refresh-button') as HTMLButtonElement;
export const dailyBudgetResetButton = document.querySelector('#daily-budget-reset-button') as HTMLButtonElement;
