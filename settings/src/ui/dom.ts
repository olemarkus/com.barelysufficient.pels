...
export const logicControlForm = document.querySelector('#logic-control-form') as HTMLFormElement;
export const logicControlEnabledInput = document.querySelector('#logic-control-enabled') as HTMLInputElement;
export const logicBaseFloorInput = document.querySelector('#logic-base-floor-kwh') as HTMLInputElement;
export const logicUncontrolledInput = document.querySelector('#logic-uncontrolled-kwh') as HTMLInputElement;
export const logicIndoorTargetInput = document.querySelector('#logic-indoor-target-c') as HTMLInputElement;
