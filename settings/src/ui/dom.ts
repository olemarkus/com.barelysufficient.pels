...
export const hourlyPatternToggleAll = document.querySelector('#hourly-pattern-toggle-all') as HTMLButtonElement;
export const hourlyPatternToggleWeekday = document.querySelector('#hourly-pattern-toggle-weekday') as HTMLButtonElement;
export const hourlyPatternToggleWeekend = document.querySelector('#hourly-pattern-toggle-weekend') as HTMLButtonElement;
export const dailyHistoryRange7 = document.querySelector('#daily-history-range-7') as HTMLButtonElement;
export const dailyHistoryRange14 = document.querySelector('#daily-history-range-14') as HTMLButtonElement;
