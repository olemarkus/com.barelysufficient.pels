...
export const usageDayToggleYesterday = document.querySelector('#usage-day-toggle-yesterday') as HTMLButtonElement;
export const usageDayToggleToday = document.querySelector('#usage-day-toggle-today') as HTMLButtonElement;
...
export const priceDayTitle = qs('#price-day-title');
export const priceDayLabel = qs('#price-day-label');
export const priceDayStatusPill = qs('#price-day-status-pill');
export const priceDayToggleToday = document.querySelector('#price-day-toggle-today') as HTMLButtonElement;
export const priceDayToggleTomorrow = document.querySelector('#price-day-toggle-tomorrow') as HTMLButtonElement;
export const priceDayNowLabel = qs('#price-day-now-label');
export const priceDayNow = qs('#price-day-now');
export const priceDayAvg = qs('#price-day-avg');
export const priceDayRange = qs('#price-day-range');
export const priceDayChart = qs('#price-day-chart');
export const priceDayBars = qs('#price-day-bars');
export const priceDayLabels = qs('#price-day-labels');
export const priceDayLegend = qs('#price-day-legend');
export const priceDayEmpty = qs('#price-day-empty');
export const priceDayMeta = qs('#price-day-meta');
